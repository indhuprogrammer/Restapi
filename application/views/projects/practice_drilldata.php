...
if(!empty($tbl_data)) {
	echo "<table id='project_dash' class='proj-dash-table data-table proj-table-odd-even'>
			<tr>
			<th class='prac-dt' width='14%'>PRACTICE NAME</th>
			<th class='prac-dt' width='11%'>SKILL NAME</th>
			<th class='prac-dt' width='13%'>USER NAME</th>
			<th class='prac-dt' width='13%'>PROJECT NAME</th>
			<th class='prac-dt' width='13%'>CUSTOMER TYPE</th>
			<th class='prac-dt' width='10%'>PROJECT LOCATION</th>
				...
				foreach($user_sort_arr as $ukey=>$uval){
					...
					foreach($prj_arr as $p_name=>$pval) {
						...
						echo "<tr data-depth='".$i."' class='collapse '>
							...
							<td width='15%'>".$project_location[$p_name]."</td>
	...
	echo "<tr data-depth='0' class='project-dash-total' style='text-align:right'>
			<td width='80%' colspan='6' align='right'><b>TOTAL:</b></td>
