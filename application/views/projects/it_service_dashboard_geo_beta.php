...
<div id="content">
    <div class="inner">
		...
		<div class="page-title-head">
			...
			<div id="filter_section">
				<div id="advance_search" class="buttons">
					<form name="advanceFilterServiceDashboard" id="advanceFilterServiceDashboard" method="post">
						...
						<div class="pull-left adv_filter_it_service" style="margin:0px;padding-top:7px;margin-top: 7px;width: 100%;">
							<div class='pull-left'>
							...
							<div class='pull-left' id='fy_start_mon'>
								<select name='start_month' id='start_month' onchange="setFyEndMon(this.value);" style="width: 90%;">
									<option value=''>--Select--</option>
							...
							<div class='pull-left' id='fy_end_mon'>
								<select name='end_month' id='end_month' style="width: 90%;">
									<option value=''>--Select--</option>
									<?php if(!empty($fy_month) && count($fy_month)>0) { ?>
			...
			<div class="buttons export-to-excel pull-right mrgin0" style="padding-top: 8px;">
...
$( "#advance_search" ).on( "click", "#advance", function(e) {
	...
	var type = $('#type_dashboard').val();
	var url = '';
	if(type == 'geography'){
	   url = site_base_url+"projects/it_service_dashboard/";	
	}else{
	  url = site_base_url+"projects/it_service_dashboard/practice";
	}
...
{	
	...
	if(type == 'practice'){
	   ...
	   var f_data =form_data+'&practice='+practice+'&clicktype='+clicktype;
	}else{
	  url = site_base_url+'projects/it_service_dashboard/service_dashboard_data_geography';
	  var f_data =form_data+'&geo_graphy='+practice+'&clicktype='+clicktype;
	}
	$.ajax({
		type: "POST",
		url: url,
