...
// echo "<pre>";print_r($resource_cost_arr);die;
	...
	echo "<table id='project_dash' class='data-table'>
		...
		foreach($sort_ar as $p_name=>$user_ar) {
			...
			echo "<tr data-depth='".$i."' class='collapse'>
				...
				<th width='15%' align='left' class='lft-ali'>SUB TOTAL(PROJECT WISE):</th>
				<th width='15%' align='left' class='lft-ali'>".$company."</th>
				<th width='15%' align='left' class='lft-ali'>".$customer_type."</th>
				<th width='15%' align='left' class='lft-ali'>".$project_location."</th>
				<th width='10%' align='right' class='lft-ali'>".$geo_region."</th>
