<h5 class="revenue_compare_head_bar">
	...
	<span class="revenue_filter">
		<input type="radio" name="inv_filter_by" class="inv_filter_geo_by" value="inv_month" <?php if($inv_filter_by == 'inv_month') echo "checked='checked'"; ?> />&nbsp;By Month &nbsp;&nbsp;
		<input type="radio" name="inv_filter_by" class="inv_filter_geo_by" value="inv_year" <?php if($inv_filter_by == 'inv_year') echo "checked='checked'"; ?> />&nbsp;By Year
	</span>
</h5>
<?php
