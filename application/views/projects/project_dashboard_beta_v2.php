...
$(document).ready(function(){
  ...
  function getMembers() {
    ...
    'practices':practices,'skill_id':skill_id,'start_date':start_date,'end_date':end_date,
...
function getData(resource_type, dept_type)
{
  ...
  //metrics filter
	...
	$.ajax({
		...
		data: formdata+'&resource_type='+resource_type+'&dept_type='+escape(dept_type)+'&filter_group_by=0',
		cache: false,
		beforeSend:function() {
			$('#filter_group_by').prop('selectedIndex',0);
