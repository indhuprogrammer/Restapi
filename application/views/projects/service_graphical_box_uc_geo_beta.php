...
<div class="pull-right chlid_container clearfix">
	<h5 class="dash-tlt">Geography wise</h5>
	<?php
		...
		?>
		<div class="graph_box">
			<div id="<?php echo str_replace('&','',$key); ?>" style="height: 150px !important; width: 202px !important;"></div>
		</div>
		<?php if($i == 3 || $i == 6) { ?>
		<div class="clear"></div>
		<?php } ?>
...
<script type="text/javascript" src="assets/js/projects/service_graphical_box_uc.js?v1=1"></script>
