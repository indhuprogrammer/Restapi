...
$(function() {
	...
	$('#service_dashboard_export_excel').click(function() {
		var practice    = $("#type_dashboard").val();
		
		if(practice == 'practice'){
			var type_url = site_base_url+"projects/it_service_dashboard/service_dashboard_data/";
			var prac_id          = <?php echo $practices_id ?>; 
			var practic  = '<input id="practice" type="hidden" name="practice" value="'+prac_id+'" />';
		}else{
			var type_url = site_base_url+"projects/it_service_dashboard/service_dashboard_data_geography/"; 	
			var geo_id          = <?php echo $practices_id ?>;
			var practic  = '<input id="geo_graphy" type="hidden" name="geo_graphy" value="'+geo_id+'" />';
		}
