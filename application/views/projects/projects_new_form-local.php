		...
		<div id="tabs-project" >
          ...
          <tr>
            ...
            <td><strong>Practice: <span class='mandatory_asterick'>*</span></strong></td>
						...
						<td>					
							<label for="sow_status_signed"><input type="radio" name="sow_status" id="sow_status_signed" value="1" tabindex="11" /> Signed</label>
							<label for="sow_status_unsigned"><input type="radio" name="sow_status" id="sow_status_unsigned"  value="0" tabindex="12" /> Un signed</label>
            ...
            <td width="115"><strong>Industry: <span class='mandatory_asterick'>*</span></strong>
					...
					<tr>
						...
						<td>					
							<label for="project_center"><input type="radio" name="project_category" onclick="change_project_category(1);" id="project_center"  value="1" tabindex="6" /> Profit Center</label>
							<label for="cost_center"><input type="radio" name="project_category" id="cost_center" onclick="change_project_category(2);"  value="2" tabindex="7" /> Cost Center</label>
					...
					<tr>
						...
						<td>					
							...
							<?php
								foreach($this->cfg['customer_type'] as $status_key=>$status_val) {
									...
									<input type="radio" name="customer_type" id="ext_customer_type" value="<?php echo $status_key ?>" tabindex="7" /><?php echo  $status_val ?></label>
									</label>    
									<?php
								}
                             ?>
						...
						<td><strong>Redmine:</strong></td>
						<td>
							<label for="create_redmine_project"><input type="checkbox" name="redmine_project_status" id="create_redmine_project_check" /> Create Project in Redmine</label>
						</td>
					</tr>
					<tr>
...
<script type="text/javascript" src="assets/js/projects/project_lead_confirmation_view.js?v=3"></script>
<style>
	.ui-autocomplete{
		z-index: 99999;
	}
...
function RenderThumbnail(e, readerEvt)
        {
            ...
            li.innerHTML = ['<div class="image-div">' +
                ...
                readerEvt.name, '"/></p>' + '<span class="close">&times;</span> <input id="multi_upload" type="hidden" name="multi_upload[]" value="'+readerEvt.name+'" /> </div>'].join('');
...
function RenderThumbnail(e, readerEvt)
        {
            ...
            li.innerHTML = ['<div class="image-div">' +
                '<p class="thumb"  title="', escape(readerEvt.name), '" data-id="',
                readerEvt.name, '"/></p>' + '<span class="close">&times;</span> <input id="sow_ajax_file_uploader" type="hidden" name="sow_ajax_file_uploader[]" value="'+readerEvt.name+'" /> </div>'].join('');
