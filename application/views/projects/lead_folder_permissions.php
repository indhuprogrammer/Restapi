...
<table cellpadding="0" cellspacing="0" id="fixTable" class="" >
	<thead>
		<tr>
		...
		foreach($lead_folders as $folder_id => $folder_name) 
		{
			...
			<tr>
				...
				<td class="user_permision">
					<div>
						<input type="radio" id="<?=$rd_name?>_read" name="<?=$rd_name?>" class="<?php echo 'rd-read-'.$member['userid_fk']?> permission_changed" value="1" <?=$read_checked?> /> R
					</div>
					<div>
