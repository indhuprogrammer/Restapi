		...
		<div class="clearfix">
			...
			<div id="uc_container_overall_wrap">
				<div class="uc-head fliter-section-wrap">
					...
					<div id="filter_section" class="pull-right">						
						<div id="uc_advance_search" style="padding-bottom:5px;">			
							<?php $attributes = array('id'=>'filter_uc_dashboard_geo','name'=>'filter_uc_dashboard_geo','method'=>'post'); ?>
							<?php echo form_open_multipart("projects/dashboard/sevice_graph_dashboard", $attributes); ?>
								...
								<div>
									<table cellpadding="0" cellspacing="0" class="data-table leadAdvancedfiltertbl" >
										<tr>
											<td align="left">
												<input type="radio" name="uc_filter_by" id="uc_cost" class="uc_filter_by_cls_geo" value="cost" checked />&nbsp;By Cost&nbsp;&nbsp;
												<input type="radio" name="uc_filter_by" id="uc_hour" class="uc_filter_by_cls_geo" value="hour" />&nbsp;By Hour 
											</td>
				...
				<?php if(!empty($uc_graph_val)) { ?>
					<?php  echo $this->load->view('projects/service_graphical_box_uc_geo_beta', $uc_graph_val, true); ?>
		       <?php } ?>
				</div>
			</div>
			...
			<div id="revenue_container_overall_wrap">
				...
				<div class="revenue_container_wrap" id="revenue_container">
					...
					<div class="pull-left overall_container">
						<h5 class="dash-tlt"><?php echo "Geography Wise - Revenue (".$this->default_cur_name.")"; ?></h5>
						<div id="revenue_pie" class="plot"></div>
					</div>
					<div class="pull-right revenue_chlid_container clearfix" id="inv_filter">
						<?php echo $this->load->view('projects/service_graphical_box_inv_compare_geo', $inv_filter_by); ?>
					</div>
					<div class="clear"></div>
					...
					<div class="pull-right revenue_chlid_container clearfix" style="margin-top: 10px;" id="prac_filter">
						<?php echo $this->load->view('projects/service_graphical_revenue_compare_geo', $prac_filter_by); ?>
					</div>					
				</div>
			</div>
			...
			<div id="contribution_container_overall_wrap">
				<div class="uc-head">
					<h2 class="pull-left borderBtm" style="margin-top: 20px;"><?php echo "Trend Analysis (".date('F Y', strtotime($start_date))." - ".date('F Y', strtotime($end_date.' -1 month')).")"; ?></h2>
					<div id="filter_section" class="pull-right">
						<div class="clear"></div>
						<div id="advance_search" style="padding-bottom:15px;">			
