...
if(count($resdata)>0) {
	...
	foreach($resdata as $rec) {	
		...
		if(empty($max_hours_resource->practice_max_hours)){
			$max_hours_resource = get_practice_max_hour_by_financial_year( 6, $financialYear); //Default BPO Mapped
			$practice_id		= 6;
		}

		$timesheet_data[$rec->username]['practice_id'] 	= $practice_id;
