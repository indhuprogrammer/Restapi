...
$(function(){
    ...
    var c_date = $('#c_date').val();
		...
		var params = {package_id:pack_name,sub_type_name:sub_type_name,start_date:start_date,end_date:end_date,sub_name:sub_name,customer:customer,status:status,owner:owner,leadassignee:leadassignee,regionname:regionname,countryname:countryname,statename:statename,locname:locname};
