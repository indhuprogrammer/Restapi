...
$('#pjt_search_form').submit(function() {
	...
	var project_geography 	= $("#project_geography").val();
	var project_location 	= $("#project_location").val();
	if(keyword == "Project Title, Name or Company") {
		keyword = '';
	}
	
	var params = {'pjtstage':pjtstage,'customer':customer,'service':service,'practice':practice,'divisions':divisions,'customer_type':customer_type,'pm':pm,'keyword':encodeURIComponent(keyword),'datefilter':datefilter,'from_date':from_date,'to_date':to_date,'project_geography':project_geography,'project_location':project_location};
...
$("#search_advance").click(function() {
	...
	var params = {'pjtstage':pjtstage,'customer':customer,'service':service,'business_unit_id':business_unit_id,'department_id':department_id,'practice':practice,'divisions':divisions,'customer_type':customer_type,'pm':pm,'keyword':encodeURIComponent(keyword),'datefilter':datefilter,'from_date':from_date,'to_date':to_date,'project_geography':project_geography,'project_location':project_location};
	params[csrf_token_name] = csrf_hash_token; 
	if($(this).attr("id") == 'advanceFilters_pjt'){
		$('#search_advance').hide();
		$('#save_advance').hide();
...
function save_search() {
	...
	var params = {'pjtstage':pjtstage,'customer':customer,'service':service,'business_unit_id':business_unit_id,'department_id':department_id,'practice':practice,'divisions':divisions,'customer_type':customer_type,'pm':pm,'datefilter':datefilter,'from_date':from_date,'to_date':to_date};
	params[csrf_token_name] = csrf_hash_token; 
	...
	$.ajax({
		...
		cache: false,
		data: "search_name="+search_name+"&is_default="+is_default+"&pjtstage="+pjtstage+"&customer="+customer+"&service="+service+"&divisions="+divisions+"&customer_type="+customer_type+"&pm="+pm+"&datefilter="+datefilter+"&department_id="+department_id+"&business_unit_id="+business_unit_id+"&practice="+practice+"&from_date="+from_date+"&to_date="+to_date+'&'+csrf_token_name+'='+csrf_hash_token,
		beforeSend:function(){
