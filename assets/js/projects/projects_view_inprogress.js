...
$(function() {
	...
	$("#metrics_data").click(function(){
		...
		var geo_graphy    = $('#project_geography').val();
		...
		switch(export_proj_type) {
			...
			case 'no_search':
				...
				var form_data = $("#filter_metrics").serialize()+'&stages='+stage+'&customers='+customers+'&service='+service+'&practice='+practice+'&business_unit_id='+business_unit_id+'&department_id_fk='+department_id_fk+'&datefilter='+datefilter+'&from_date='+from_date+'&to_date='+to_date+'&divisions='+divisions+'&keyword='+encodeURIComponent(keyword)+'&'+csrf_token_name+'='+csrf_hash_token;
		...
		switch(export_proj_type) {
			...
			case 'no_search':
				...
				var form = $('<form action="' + url + '" method="post">' +
							  ...
							  '<input type="hidden" name="department_id_fk" value="' +department_id_fk+ '" />' +
							  '<input type="hidden" name="practices" value="' +practice+ '" />' +
							  '<input type="hidden" name="geo_graphy" value="' +geo_graphy+ '" />' +
