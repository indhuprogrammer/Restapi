...
$(document).ready(function() {
	...
	$(document).delegate('button#reg_cancel','click',function() {
		window.location.href= site_base_url+"regionsettings/region_settings";
		return false;
	});
});
...
$(document).ready(function() {
	...
	$(document).delegate('a.editCountry','click',function() {
		var url = $(this).attr('href')+'?script=script';
		block_msg();
		$.blockUI({ css: { 
				border: 'none', 
				padding: '15px', 
	...
	$(document).delegate('#country_cancel','click',function() {
		window.location.href=site_base_url+"regionsettings/region_settings?label=country"
		return false;
	});
});
...
$(document).ready(function() {
	...
	$(document).delegate('button#state_cancel','click',function() {
		window.location.href= site_base_url+"regionsettings/region_settings?label=state"
		return false;
	});
...
$(document).ready(function() {
	...
	$(document).delegate('button#location_cancel','click',function() {
		window.location.href= site_base_url+"regionsettings/region_settings?label=location";
		return false;
	});
