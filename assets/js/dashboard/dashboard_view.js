...
if(viewlead==1) {
	...
	$(document).ready(function() {
		if (dashboard_s9!='') {
			...
			var pie4legendTable = $('#pie4').find('.jqplot-table-legend').first();
			pie4legendTable.css('display','block');
			pie4legendTable.css('z-index',100);
			pie4legendTable.css('height','400px');
			pie4legendTable.css('top','20px');
			pie4legendTable.css('overflow-y','scroll');
