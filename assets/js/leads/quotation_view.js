...
$("#search_advance").click(function() {
    $('#advance_search_results').html('<div id="ajax_loader" style="margin: 20px;" align="center">Loading Content.<br><img alt="wait" src="'+site_base_url+'assets/images/ajax_loader.gif"><br>Thank you for your patience!</div>');
	$('#search_advance').hide();
	$('#save_advance').hide();
	$('#load').show();
